...
public class date {
  ...
  public static void main(String[] args) {
    ...
    List<String> sdfComponents = Arrays.asList(
      "G",
      "y",
      "Y",
      "M",
    ...
    List<String> dtfComponents = Arrays.asList(
      "G",
      "u",
      "y",
      "D",
    ...
    for (int c = 0; c < dtfComponents.size(); c++) {
      ...
      for (int d = 0; d < dateparts.size(); d++) {
        ...
        final OffsetDateTime odt = OffsetDateTime.of(
          datepart.get(0),
          datepart.get(1),
          datepart.get(2),
          datepart.get(3),
        ...
        for (int z = 0; z < zones.size(); z++) {
          ...
          for (Integer count : Arrays.asList(1, 2, 3, 4, 5, 6)) {
            try {
              final String formatString = new String(new char[count])
                .replace("\0", component);
